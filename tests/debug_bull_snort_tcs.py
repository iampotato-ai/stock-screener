...
current_gap = (dma200.iloc[-1] - charge is negative, so I’ll fix the sign.
...
That's correct as in the original. I’ll keep it.

Let me write the full file again, but I see that I made a typo in the previous attempt: I wrote "charge" instead of "close". I'll correct it.
...
print(f"Cane range: {candle_range:.2f}")
